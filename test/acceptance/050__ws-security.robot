...
Digest No Nonce Or Created
    ...
    Call Soap Method    theAnswer
    ${digest}=    Get Password
    Should Be Equal As Strings    ${digest}    W6ph5Mm5Pz8GgiULbPgzG37mj9g=
...
Digest
    ...
    Call Soap Method    theAnswer
    ${digest}=    Get Password
    Should Be Equal As Strings    ${digest}    CBb7a2itQDgxVkqYnFtggUxtuqk=
    ${created}=    Get Created In UsernameToken
    Should Be Equal As Strings    ${created}    2010-06-08T07:26:50Z
    ${nonce}=    Get Nonce
    Should Be Equal As Strings    ${nonce}    5ABcqPZWb6ImI2E6tob8MQ==
